...
-- 2023-08-16,ADinkel,Finished Assignment
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_ADinkel')
	 Begin 
	  Alter Database [Assignment06DB_ADinkel] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_ADinkel;
	 End
	Create Database Assignment06DB_ADinkel;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_ADinkel;
...
CREATE VIEW vInventoriesByEmployeesByDates
	...
	SELECT TOP 1000000000
		...
		GROUP BY vInventories.InventoryDate, vEmployees.EmployeeFirstName, vEmployees.EmployeeLastName
...
CREATE VIEW vInventoriesByProductsByCategoriesByEmployees
	...
	SELECT TOP 1000000000
		...
		FROM vCategories 
			...
			INNER JOIN vEmployees as Mgr
			ON Emp.ManagerID = Mgr.EmployeeID
		ORDER BY vCategories.CategoryID, vProducts.ProductID, vInventories.InventoryID, Employee;
GO
